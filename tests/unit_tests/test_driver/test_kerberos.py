...
class TestKerberosConstruction:
    ...
    def test_real_http_client_sets_kerberos_hostname_from_host(self, fake_spnego):
        ...
        assert client._use_kerberos is True
        assert client._kerberos_hostname == "chnode1"
    ...
    def test_real_http_client_kerberos_hostname_override(self, fake_spnego):
        ...
        assert client._kerberos_hostname == "chnode1.example.com"
...
def _build_sync_kerberos_client(hostname="chnode1.example.com"):
    ...
    client._use_kerberos = True
    client._kerberos_hostname = hostname
...
class TestSyncKerberosRequest:
    def test_sends_fresh_negotiate_header_per_request(self):
        ...
        with patch("clickhouse_connect.driver.httpclient.negotiate_auth_header", side_effect=lambda h: next(headers_seq)):
    ...
    def test_hostname_passed_to_negotiate(self):
        ...
        with patch("clickhouse_connect.driver.httpclient.negotiate_auth_header", return_value="Negotiate xyz") as mock_negotiate:
            client._raw_request(b"SELECT 1", {})
...
def _build_async_kerberos_client(hostname="chnode1.example.com", responses=None):
    ...
    client._session_lease = _FakeAsyncLease(session)
...
class TestAsyncKerberosRequest:
    ...
    async def test_sends_negotiate_header(self):
        ...
        with patch("clickhouse_connect.driver.asyncclient.negotiate_auth_header", return_value="Negotiate xyz") as mock_negotiate:
